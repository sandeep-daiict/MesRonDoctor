...
public class ExtractSymptomToDisease 
{
	...
	public static void main(String[] args) 
	{
			...
			for(int i=24;i<26;i++)
			{
				...
				String url ="http://www.mayoclinic.com/health/symptoms/SymptomIndex/METHOD=displayAlphaList&LISTTYPE=mcSymptom&LETTER="+(char)(i+97);
